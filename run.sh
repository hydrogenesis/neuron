...
#bazel build //main:main --verbose_failures && bazel-bin/main/main 94 data/Ball_and_axon.swc && python plot.py
#bazel build //main:main --verbose_failures && gdb --args bazel-bin/main/main 94 data/Ball_and_stick.swc && python plot.py
